#ifndef WLM_WAYLAND_REGISTRY_H_
#define WLM_WAYLAND_REGISTRY_H_
...
#define WLM_WAYLAND_REGISTRY_BIND_SINGLETON(proxy_interface, min_version, max_version, is_required, proxy_member) \
    (wlm_wayland_registry_bind_singleton_t){ \
        .spec = (wlm_wayland_registry_bind_spec_t) { \
            .interface = &proxy_interface, \
            .version_min = min_version, \
        ...
        .proxy_offset = offsetof(ctx_t, proxy_member), \
    }
...
typedef struct ctx_wl_registry {
    ...
    struct wl_list /* wlm_wayland_registry_bound_global_t */ bound_globals;
